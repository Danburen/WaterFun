  ...
  <el-card class="module-card" shadow="never">
    ...
    <div class="system-list" @scroll.passive="onScroll">
      ...
      >
        ...
        <div class="notification-content">{{ item.content?.displayText || item.content }}</div>
      </el-card>
...
.notification-content { margin-top: 10px; color: #374151; line-height: 1.7; white-space: pre-wrap; word-break: break-word; }
