...
import { getContact } from "~/api/resourceApi";
...
onMounted(()=>{
  legalDocProps.title = i18n.t('contact.title');
  getContact(LangMap[i18n.locale.value] || 'zh_CN').then((response : DataApiResponse<FileResDataType>) => {
