...
import { getTerms } from "~/api/resourceApi";
...
onMounted(()=>{
  legalDocProps.title = i18n.t('auth.terms');
  getTerms(LangMap[i18n.locale.value] || 'zh_CN').then((response : DataApiResponse<FileResDataType>) => {
