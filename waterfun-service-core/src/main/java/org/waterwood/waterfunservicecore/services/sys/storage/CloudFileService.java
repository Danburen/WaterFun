...
public interface CloudFileService {
     ...
     * @param packagedBizTargetId packaged biz target id, Usually generated by{@link BizTargetIdPackager}
     ...
     */
    PresignedResp buildPutPolicyWithBiz(CloudStorageRootKey keyRoot, String path, String packagedBizTargetId);
     ...
     * @param idType ID Type extends {@link Serializable}
     * @return payload with target id type
     * @param <T> target id type
     */
    <T extends Serializable> BizPayload<T> parseToken(String token, Class<T> idType);
     ...
     */
    BizPayload<String> parseToken(String token);
}
